...
move_uploaded_file($_FILES['file']['tmp_name'],"test/".$fn1);

$c = new compareImages();
$ch=$c->compare("test/".$fn1, "finger/".$r1['fimg1']);
$ch2=$c->compare("test/".$fn1, "finger/".$r1['fimg2']);
$ch3=$c->compare("test/".$fn1, "finger/".$r1['fimg3']);
	if($ch<=1 || $ch2<=1 || $ch3<=1)
	{
	?>
	<script language="javascript">
	
	window.location.href="verify_dec.php?fid=<?php echo $fid; ?>";
	</script>
	<?php
	}
	else
	...
	window.location.href="owner_decrypt.php?act=wrong&fid=<?php echo $fid; ?>";
	</script>
	<?php
	}
}
        ...
        <section class="all-starups-area section-padding2">
            ...
            <div class="row">
				...
				<div class="col-md-4">
					...
					<h5 style="color:#FF6699">Put your Fingerprint for Verification......</h5>
				<form name="form1" method="post" enctype="multipart/form-data">
						...
						if($act=="wrong")
						{
						?><h5 style="color:#FF0000">Fingerprint wrong!</h5><?php
						}
						?>
						<br>
						<!--<iframe src="http://iotcloud.co.in/clouddata/verify_finger2.php?bc=<?php //echo $bc; ?>&uid=<?php //echo $uid; ?>&fid=<?php //echo $fid; ?>" frameborder="0" width="200" height="100"></iframe>-->
						<br>
            ...
            <!--Right Contents  -->
				<!--<div class="starups-img">-->
					<img src="assets/img/gallery/fing2.jpg" alt="" class="img-fluid" style="max-width: 90%; border:3px solid #FF6666; border-radius: 25px;">
				<!--</div>-->
			</div>
			</div>
        </section>
