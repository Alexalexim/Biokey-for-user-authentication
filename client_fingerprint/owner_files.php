...
//alert("File Upload and Encrypted..");
window.location.href="owner_finger_verify.php?fid=<?php echo $id; ?>&uu=<?php echo $uname; ?>&keyword=<?php echo $keyword; ?>";
</script>
<?php
...
<html class="no-js" lang="zxx">
   ...
   <body>
	...
	$qs=mysqli_query($connect,"select * from fp_files where uname='".$uname."' && status=1");
...
?>
      <tr>
		...
		<a href="upload/<?php echo $rs['upload_file']; ?>" target="_blank"><img src="assets/img/gallery/<?php echo $img; ?>" width="34" height="43"></a>
		<?php 
...
MB</td>
		...
		<a href="file_access.php?fid=<?php echo $rs['id']; ?>" style="color:#FF6666">Access</a> |
		<a href="owner_decrypt.php?fid=<?php echo $rs['id']; ?>" style="color:#FF6666">Decrypt</a> |
		<a href="download.php?file1=<?php echo $rs['upload_file']; ?>&folder1=upload" style="color:#FF6666">Download</a>
		</td>
      </tr>
		<?php
		}
...
?>
            ...
            <!--Right Contents  -->
				<!--<div class="starups-img">-->
					<img src="assets/img/gallery/showfile.jpg" alt="" class="img-fluid" style="max-width: 90%; border:3px solid #FF6666; border-radius: 25px;">
				<!--</div>-->
			</div>
			</div>
        </section>
