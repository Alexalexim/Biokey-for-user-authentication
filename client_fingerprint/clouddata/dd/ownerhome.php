...
<h4 align="center">Owner: <?php echo $uname; ?></h4>
     <!-- ABOUT -->
     <section id="about">
          <div class="container">
               <div class="row">
                         ...
                         <div class="about-info">
                              ...
                              <figure>
                                   ...
                                   <figcaption>
                                        ...
                                        <p>Data owner file upload has check by fingeprint verification </p>
                                   </figcaption>
                           </figure>
                              ...
                              <figure>
                                   ...
                                   <figcaption>
                                        <h3>File Upload and Encryption</h3>
                                        <p>Browse files upload and encrypt accessed by valid person</p>
                                   </figcaption>
                           </figure>
                              ...
                              <figure>
                                   ...
                                   <figcaption>
                                        <h3>Store to Cloud</h3>
                                        <p>Uploaded files send to Cloud accessed by valid person</p>
                                   </figcaption>
                           </figure>
                         </div>
                    </div>
                    ...
                    <div class="col-md-offset-1 col-md-4 col-sm-12">
                         <div class="entry-form">
                              <form action="#" method="post">
                                   ...
                                   <button name="btn" class="submit-btn form-control" id="form-submit">Upload Files</button>
                              </form>
                         </div>
                    </div>
