...
setTimeout(function () {
   ...
   window.location.href= 'http://localhost/Project2022/engg/client_fingerprint/verify_enc.php?bc=<?php echo $bc; ?>&uid=<?php echo $uid; ?>&fid=<?php echo $fid; ?>';
}, 6000);
</script> 
			<?php
				}
...
setTimeout(function () {
   //Redirect with JavaScript
   window.location.href= 'verify_finger.php?bc=<?php echo $bc; ?>&uid=<?php echo $uid; ?>&fid=<?php echo $fid; ?>';
}, 6000);
</script> 
			<?php
				}
