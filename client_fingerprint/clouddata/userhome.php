...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
     ...
     <section class="navbar custom-navbar navbar-fixed-top" role="navigation">
          <div class="container">
               ...
               <div class="navbar-header">
                    ...
                    <!-- lOGO TEXT HERE -->
                    <a href="#" class="navbar-brand">Cloud User</a>
               </div>

               <!-- MENU LINKS -->
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-nav-first">
                         <li class="active"><a href="userhome.php" class="smoothScroll">Home</a></li>
	...
	<h4 align="center">User: <?php echo $uname; ?></h4>
	...
	$qs=mysqli_query($connect,"select * from fp_access where uname='".$uname."'");
	...
	?>
		...
		$i++;
		$fid=$rs['fid'];
		$qs1=mysqli_query($connect,"select * from fp_files where id='".$fid."'");
	$rs1=mysqli_fetch_array($qs1);
		
		$fff=explode(".",$rs1['upload_file']);
...
?>
      <tr>
		...
		<a href="upload/<?php echo $rs1['upload_file']; ?>" target="_blank"><img src="images/<?php echo $img; ?>" width="34" height="43"></a>
		<?php 
		
		echo $rs1['upload_file']; ?></td>
        <td width="154" class="bor"><?php echo $bb; ?>
MB</td>
        <td width="172" class="bor">
		<a href="downfile.php?fname=<?php echo $rs1['upload_file']; ?>">Download</a> 
		</td>
      </tr>
		<?php
		}
