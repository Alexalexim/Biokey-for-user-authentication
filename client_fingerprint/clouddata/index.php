...
if(isset($btn))
{
$qry=mysqli_query($connect,"select * from fp_owner where uname='$uname' && pass='$pass'");
                    ...
                    <div class="owl-carousel owl-theme home-slider">
                              ...
                              <div class="caption">
                                   <div class="container">
                                        <div class="col-md-6 col-sm-12">
                                             ...
                                             <h3>Cloud  has designed to fit in our industry supporting all-round with latest technologies.</h3>
                         ...
                         <div class="item item-second">
                              <div class="caption">
                                   <div class="container">
                                        <div class="col-md-6 col-sm-12">
                                             <h1>Cloud Computing with Biometrics</h1>
                                             <h3>Cloud and IOT has designed to fit in our industry supporting all-round with latest technologies.</h3>
                    ...
                    <div class="col-md-offset-1 col-md-4 col-sm-12">
                         <div class="entry-form">
                              <form action="#" method="post">
                                   ...
                                   <button name="btn" class="submit-btn form-control" id="form-submit">Get started</button>
                              </form>
                         </div>
                    </div>
