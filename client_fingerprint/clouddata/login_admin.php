...
if(isset($btn))
{
$qry=mysqli_query($connect,"select * from fp_admin where username='$uname' && password='$pass' && utype='web'");
          ...
          <div class="container">
               ...
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-nav-first">
                         ...
                         <li class="active"><a href="login_user.php" class="smoothScroll">User</a></li>
                    ...
                    <div class="col-md-offset-1 col-md-4 col-sm-12">
                         <div class="entry-form">
                              <form action="#" method="post">
                                   ...
                                   <button name="btn" class="submit-btn form-control" id="form-submit">Login</button>
                              </form>
                         </div>
                    </div>
