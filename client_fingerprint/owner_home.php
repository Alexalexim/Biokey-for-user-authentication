...
<html class="no-js" lang="zxx">
   ...
   <body>
    ...
    <main>
        ...
        <section class="all-starups-area section-padding2">
            ...
            <div class="row">
				...
				<iframe src="upform.php" width="300" height="300" frameborder="0"></iframe>
                <?php
            ...
            <!--Right Contents  -->
				<!--<div class="starups-img">-->
					<img src="assets/img/gallery/upimg1.jpg" alt="" class="img-fluid">
				<!--</div>-->
			</div>
			</div>
        </section>
	...
	$qs=mysqli_query($connect,"select * from fp_files where uname='".$uname."' && status=0");
...
MB</td>
		...
		<a href="owner_finger_verify.php?fid=<?php echo $rs['id']; ?>" style="color:#FF6666">Encrypt</a> |
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6">
                            <div class="single-footer-caption mb-50">
                                <div class="footer-tittle">
                                    ...
                                    <ul>
                                        <li><a href="owner_files.php">Files</a></li>
                                        <li><a href="reg_user.php">User Info</a></li>
                                        <li><a href="owner_send.php">Send to Cloud</a></li>
                                        <li><a href="logout.php">Logout</a></li>
                                    </ul>
                                </div>
