...
<html class="no-js" lang="zxx">
   ...
   <body>
    ...
    <main>
		...
		<div class="section-tittle section-tittle3" align="center">
							<span>Welcome <?php echo $name; ?></span>
							<h3>File Decryption</h3>
							<h5>Downloaded Files from Cloud</h5>
						</div>
	...
	$qs2=mysqli_query($connect,"select * from fp_access where uname='".$uname."'");
	$ns2=mysqli_num_rows($qs2);
	if($ns2>0)
	{
	?>
		...
		{
		$qs=mysqli_query($connect,"select * from fp_files where id='".$rs2['fid']."'");
...
MB</td>
        <td width="339" class="bor"><?php echo $rs2['rdate']; ?></td>
        <td width="172" class="bor">
		<a href="user_decrypt.php?fid=<?php echo $rs['id']; ?>" style="color:#FF6666">Decrypt</a> 
		</td>
      </tr>
		<?php
		}
