...
if(isset($btn))
{
$fn1=$_FILES['file']['name'];
$fn2=$_FILES['file1']['name'];
$fn3=$_FILES['file2']['name'];
move_uploaded_file($_FILES['file']['tmp_name'],"finger/".$fn1);
move_uploaded_file($_FILES['file1']['tmp_name'],"finger/".$fn2);
move_uploaded_file($_FILES['file2']['tmp_name'],"finger/".$fn3);


$resource = imagecreatefromjpeg("sample/".$fn1);
...
mysqli_query($connect,"update fp_owner set fimg1='$fn1',fimg2='$fn2',fimg3='$fn3',img_key='$img_key' where id=$id");
?>
<script language="javascript">
window.location.href="add_finger.php?act=success&id=<?php echo $id; ?>";
</script>
<?php
}
        ...
        <section class="all-starups-area section-padding2">
            ...
            <div class="row">
				...
				<div class="col-md-4">
					...
					<h5 style="color:#FF6699">Put your Fingerprint......</h5>
				<form name="form1" method="post" enctype="multipart/form-data">
					...
					<!--	<iframe src="http://iotcloud.co.in/clouddata/reg_finger.php?bc=<?php //echo $bc; ?>&fid=<?php //echo $id; ?>" frameborder="0" width="200" height="100"></iframe>-->
						<br>
						</form>
                ...
                <h5 style="color:#009900">Fingerprint Added Success......</h5>
				<h5 style="color:#009900">BioKey Generated and Stored......</h5>
				<script language="javascript">
	setTimeout(function () {
 ...
 window.location.href="index.php";
            ...
            <!--Right Contents  -->
				<!--<div class="starups-img">-->
					<img src="assets/img/gallery/fing.jpg" alt="" class="img-fluid" style="max-width: 90%; border:3px solid #FF6666; border-radius: 25px;">
				<!--</div>-->
			</div>
			</div>
        </section>
