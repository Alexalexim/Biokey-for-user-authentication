...
$ch3=$c->compare("test/".$fn1, "finger/".$r1['fimg3']);
	...
	window.location.href="verify_enc.php?fid=<?php echo $fid; ?>";
	</script>
	<?php
	}
	else
	...
	window.location.href="owner_finger_verify.php?act=wrong&fid=<?php echo $fid; ?>";
	</script>
	<?php
	}
}
        ...
        <section class="all-starups-area section-padding2">
            ...
            <div class="row">
				...
				<form name="form1" method="post" enctype="multipart/form-data">
						...
						?>
						<!--<iframe src="http://iotcloud.co.in/clouddata/verify_finger.php?bc=<?php //echo $bc; ?>&uid=<?php //echo $uid; ?>&fid=<?php //echo $fid; ?>" frameborder="0" width="200" height="100"></iframe>-->
						<br>
