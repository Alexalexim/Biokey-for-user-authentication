...
mysqli_query($connect,"update fp_owner set fimg1='$fn1',fimg2='$fn2',fimg3='$fn3',img_key='$img_key' where id=$id && utype='user'");
?>
<script language="javascript">
window.location.href="add_finger2.php?act=success&id=<?php echo $id; ?>";
</script>
<?php
}
