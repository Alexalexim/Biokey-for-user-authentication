    ...
    <main>
        ...
        <section class="all-starups-area section-padding2">
            ...
            <div class="row">
				...
				<iframe src="send.php" width="400" height="400" frameborder="0" scrolling="no"></iframe>
                
            </div>
			<div class="col-md-5">
            <!--Right Contents  -->
				<!--<div class="starups-img">-->
					<img src="assets/img/gallery/upimg2.jpg" alt="" class="img-fluid">
				<!--</div>-->
			</div>
			</div>
        </section>
